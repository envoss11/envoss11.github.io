...
tags_list:
  ...
  - "Tag Two"
  - "Tag Three"
# The dotted-leader table under the page header. Any label/value pairs work.
facts:
  - label: "Context"
    value: "Where this work happened"
  - label: "Data"
    value: "What it ran on"
  - label: "Deliverable"
    value: "What someone could actually use"
# Pill buttons under the header. icon: external | github | file
links:
  - label: "Live demo"
    icon: "external"
...
couple of paragraphs read comfortably before the first heading.

## The deliverable

A second-level heading gets a chapter plate. Use these to break the write-up into the
handful of beats a reader actually wants: what was built, how it did, what you would do
differently.

Body copy supports the usual Markdown — *emphasis*, `inline code`, and
[links](https://example.com/) — plus images:

<!-- ![Alt text describing the chart](/assets/images/example-chart.png) -->
